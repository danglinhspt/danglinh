...
$(window).load(function() {
		if(document.cookie.indexOf("adf") == -1)
		{
			...
			$("#myModal").html("<a href='https://goo.gl/KjAq4n' target='_blank'><img src='https://image.reic.info/news/850/item.8_2016/source/palm_heights_nam_rach_chiec_6-636079427163037428.jpg' width='500px'/><br/>Can ho PalmHeights</a>. LH 0932192893. <h2><a class='close-linhnguyen-modal'>X</a></h2>");
